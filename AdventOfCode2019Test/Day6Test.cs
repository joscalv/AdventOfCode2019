...
namespace AdventOfCode2019Test
{
    public class Day6Test
    {
        ...
        {
            var expected = 42;
            var orbits = Day6.Day6.ReadInput(@"Inputs\inputDay6Test1.txt");
        ...
        {
            var expected = 4;
            var orbits = Day6.Day6.ReadInput(@"Inputs\inputDay6Test2.txt");
            var orbitAnalyzer = new OrbitAnalyzer(orbits);
