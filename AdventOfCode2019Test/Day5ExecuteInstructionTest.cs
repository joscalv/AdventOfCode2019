...
namespace AdventOfCode2019Test
{
    public class Day5ExecuteInstructionTest
    {
        ...
        public void ExecuteInstruction1Test()
        {
            ...
            var pc = 0;
            var instruction01 = InstructionUtils.GetInstruction(program, 0, new ConsoleInput(), new ConsoleOutput());
        ...
        public void ExecuteInstruction2Test()
        {
            ...
            var pc = 0;
            var instruction02 = InstructionUtils.GetInstruction(program, 0, new ConsoleInput(), new ConsoleOutput());
